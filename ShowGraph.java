...
class ShowGraph {
    ...
    public void displayEdges() {
        ...
        for (Edge edge : graph.printEdges())
    ...
    public void displayVerticesDescending() {
        ...
        for (int vertex : graph.printVerticesDescending())
    ...
    public void getVerticesMore(int x) {
        ...
        for (int vertex : graph.getVerticesMore(x))
            System.out.print(vertex + " ");
        System.out.println(); // Пустая строка для разделения выводов
    }
    ...
    public void getConnectedComponents() {
        ...
        List<List<Integer>> components = graph.getConnectedComponents(graph);
    ...
    public void displayReachableInTwoSteps(int start) {
        ...
        for (int vertex : Graph.getReachableVerticesIn2Moves(graph, start))
            System.out.print(vertex + " ");
        System.out.println(); // Пустая строка для разделения выводов
    }
    ...
    public void displayReachableInSteps(int start, int steps) {
        ...
        for (int vertex : Graph.getVerticesReachableInKSteps(graph, start, steps))
            System.out.print(vertex + " ");
        System.out.println(); // Пустая строка для разделения выводов
    }
